...
void append_stack_region_submit_epoch_ordering_json(
  ...
  for (auto& item : submit_level_proof_by_submit_key) {
    ...
    for (const auto& reason : proof.reject_reason_counts) {
      if (reason.first != "none" && reason.second > reject_count) {
        reject_reason = reason.first;
        reject_count = reason.second;
      }
    }
    const bool complete =
        proof.records > 0u && proof.complete_records == proof.records &&
    ...
    row << "schema=StackBoundarySubmitLevelEquivalenceProof.v0"
        ...
        << proof.writes_covered_records
        << " submit_equivalence_proof_complete=" << (complete ? "1" : "0")
        << " reject_reason=" << reject_reason
        << " count=" << proof.records
        << " bytes=" << proof.bytes;
  ...
  uint64_t submit_level_equivalence_candidate_records = 0u;
  uint64_t submit_level_equivalence_candidate_bytes = 0u;
  ...
  for (const auto& row : submit_level_equivalence_proof_rows) {
    ...
    const uint64_t count = std::max<uint64_t>(parsed_u64(fields, "count"), 1u);
    const uint64_t bytes = parsed_u64(fields, "bytes");
    submit_level_equivalence_candidate_records += count;
    submit_level_equivalence_candidate_bytes += bytes;
    if (field_or(fields, "submit_equivalence_proof_complete", "0") == "1") {
      submit_level_equivalence_complete_records += count;
      submit_level_equivalence_complete_bytes += bytes;
    }
    ...
    submit_level_matched_barrier_records +=
        parsed_u64(fields, "matched_barrier_records");
    submit_level_covered_by_barrier_count +=
        parsed_u64(fields, "covered_by_barrier_count");
  ...
  append_u64_map_object(
      out, stack_carry_visibility_consumer_binding_source_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_producer_binding_status_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_producer_binding_status_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_producer_binding_status_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_producer_binding_status_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_next_consumer_binding_status_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_next_consumer_binding_status_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_next_consumer_binding_status_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_next_consumer_binding_status_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_next_consumer_binding_source_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_next_consumer_binding_source_counts);
  append_json_comma(out, ordering_first);
  ...
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_barrier_target_status_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_barrier_target_status_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_barrier_target_status_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_barrier_target_status_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_barrier_planning_status_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_barrier_planning_status_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_barrier_planning_status_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_barrier_planning_status_bytes);
  append_json_comma(out, ordering_first);
  ...
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_actual_norm1_input_status_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_actual_norm1_input_status_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_actual_norm1_input_status_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_actual_norm1_input_status_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_actual_norm1_input_source_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_actual_norm1_input_source_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_actual_norm1_input_source_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_actual_norm1_input_source_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_actual_norm1_input_producer_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_actual_norm1_input_producer_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_actual_norm1_input_producer_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_actual_norm1_input_producer_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_actual_norm1_input_barrier_status_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_actual_norm1_input_barrier_status_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_actual_norm1_input_barrier_status_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_actual_norm1_input_barrier_status_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_old_carry_retirement_status_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_old_carry_retirement_status_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_old_carry_retirement_status_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_old_carry_retirement_status_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_transition_chain_status_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_transition_chain_status_counts);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_transition_chain_status_bytes\":";
  append_u64_map_object(
      out, stack_carry_visibility_transition_chain_status_bytes);
  append_json_comma(out, ordering_first);
  out << "\"stack_carry_visibility_submit_equivalence_blocker_counts\":";
  append_u64_map_object(
      out, stack_carry_visibility_submit_equivalence_blocker_counts);
  append_json_comma(out, ordering_first);
  ...
  append_json_comma(out, stack_boundary_first);
  out << "\"submit_level_equivalence_proof\":{";
  bool submit_level_first = true;
  append_json_string(
      out,
      "schema",
      "StackBoundarySubmitLevelEquivalenceProof.v0",
      submit_level_first);
  append_json_bool(out, "behavior_neutral", true, submit_level_first);
  append_json_bool(
      out, "default_behavior_unchanged", true, submit_level_first);
  append_json_u64(
      out,
      "candidate_submit_records",
      submit_level_equivalence_candidate_records,
      submit_level_first);
  append_json_u64(
      out,
      "candidate_submit_bytes",
      submit_level_equivalence_candidate_bytes,
      submit_level_first);
  append_json_u64(
      out,
      "complete_submit_records",
      submit_level_equivalence_complete_records,
      submit_level_first);
  append_json_u64(
      out,
      "complete_submit_bytes",
      submit_level_equivalence_complete_bytes,
      submit_level_first);
  append_json_u64(
      out,
      "pending_dispatch_count",
  ...
  append_json_bool(
      ...
      submit_level_equivalence_candidate_records > 0u &&
          submit_level_equivalence_complete_records ==
              submit_level_equivalence_candidate_records,
      submit_level_first);
  append_json_string(
  ...
  out << "\"reject_reason_counts\":";
  append_u64_map_object(out, submit_level_reject_reason_counts);
  append_json_comma(out, submit_level_first);
