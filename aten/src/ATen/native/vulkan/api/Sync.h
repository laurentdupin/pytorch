...
struct StackRegionSingleRecordingPlanRequest final {
  std::string stack_region_id = "unknown";
  std::string stack_region_instance_id = "missing";
...
struct StackRegionSingleRecordingPlanResult final {
  bool plan_record_emitted = true;
  bool plan_present = true;
...
struct StackRegionCommandBufferAcquireHookRequest final {
  ...
  std::string requested_lifetime_scope = "stack_region";
  std::string single_recording_plan_key = "missing";
  std::string single_recording_plan_status =
      "stack_region_single_recording_plan_missing";
  std::string single_recording_plan_top_blocker =
      "missing_stack_region_single_recording_plan";
  std::string single_recording_plan_borrowed_context_lease_status =
      "missing_stack_region_single_recording_plan";
  std::string single_recording_plan_current_execution_mode =
      "missing_stack_region_single_recording_plan";
...
struct StackRegionCommandBufferAcquireHookResult final {
  ...
  std::string single_recording_plan = "StackRegionSingleRecordingPlan.v0";
  std::string single_recording_plan_key = "missing";
  std::string single_recording_plan_status =
      "stack_region_single_recording_plan_missing";
  std::string single_recording_plan_top_blocker =
...
struct StackRegionPendingRetireTransferRequest final {
  std::string stack_region_id = "unknown";
  std::string stack_region_instance_id = "missing";
  std::string boundary_id = "missing";
  std::string boundary_class = "unknown";
  std::string retire_timeline_owner_key = "missing";
...
struct StackRegionPendingRetireTransferResult final {
  bool api_present = true;
  bool plan_record_emitted = true;
  ...
  uint64_t region_exit_bound_source_id = 0u;
  ...
  std::string top_blocker = "pending_retire_transfer_unavailable";
  std::string source_match_status =
      "pending_retire_transfer_source_unavailable";
  std::string bookkeeping_exclusion_status =
  ...
  std::string requested_owner_status =
      "pending_retires_region_owner_requested";
  std::string planned_release_submit_point_status =
      "planned_region_exit_submit_point_synthetic_unimplemented";
...
TORCH_API StackRegionPendingRetireTransferResult
evaluate_stack_region_pending_retire_transfer_plan(
    const StackRegionPendingRetireTransferRequest& request,
    uint64_t context_pending_resource_count,
    uint64_t context_pending_resource_bytes,
...
TORCH_API void note_stack_region_segment_plan(
    ...
    bool planned_dispatch_count_observed,
    uint64_t total_planned_dispatch_count,
    uint64_t segment_planned_dispatch_count,
...
TORCH_API void note_stack_region_control_plane_work_batch(
    ...
    uint64_t executor_depth,
    uint64_t executor_depth_before,
    ...
    uint64_t retained_state_deferred_payload_count,
