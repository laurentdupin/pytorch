...
def check_mac_wheel_minos() -> None:
    ...
    for dylib in dylibs:
        ...
        # Parse minos from LC_BUILD_VERSION or LC_VERSION_MIN_MACOSX
        minos = None
    ...
    print(f"OK: All {len(dylibs)} dylib(s) have minos matching platform tag ({expected_minos})")
