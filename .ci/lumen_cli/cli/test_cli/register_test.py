...
def _register_pytorch_commands(subparsers: argparse._SubParsersAction) -> None:
    ...
    parser.add_argument(
        ...
        help="generate script and submit to remote execution",
    )
    parser.add_argument("--pr", type=int, help="PR number (for remote execution)")
    parser.add_argument("--commit", help="commit SHA (for remote execution)")
    parser.add_argument(
        "--input",
        metavar="KEY=VALUE",
        action="append",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="print generated script without running",
    )
    parser.add_argument(
        "--no-follow",
        action="store_true",
        default=False,
        help="don't stream RE logs",
    )
